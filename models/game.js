...
module.exports.getLast5GamesByUserId = function(user_id, callback){
    const query = {user_id: user_id}
    Game.find(query, callback).sort({_id: -1}).limit(5);
}
...
module.exports.pastWinningTickets = function(ticket_status, stake_amt, callback){
    const query = {ticket_status: ticket_status,
                   stake_amt: stake_amt}
    Game.find(query, callback);
}
...
module.exports.getOneUserTicketsWon = function(user_id, ticket_status, callback) {
